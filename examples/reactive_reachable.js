import { compileToConstructor, reactive } from '../utils.js';
...
const observer = {
  observe(instance, delta)
  {
    console.log(`reachable facts added: ${delta.added().get(instance.Reachable)}`);
  }
}
const reactiveCtr = reactive(ctr, [observer]);
const instance = reactiveCtr();
